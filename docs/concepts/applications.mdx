...
There are some concepts and requirements which are explained in this page.

## Tenant repository

As explained [previously](./multi_tenancy), Lizz follows the multi-tenant structure and each application is associated to a tenant.
