...
![Homer application screenshot](./img/intro/homer_screenshot_dark.png#dark-mode-only)
![Homer application screenshot](./img/intro/homer_screenshot_light.png#light-mode-only)
